export function SuiLogo({ className = "w-5 h-5 text-[#38bdf8]" }: { className?: string }) {
  return (
    <svg viewBox="0 0 300 383.5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path fillRule="evenodd" clipRule="evenodd" d="M240.1,159.9c15.6,19.6,25,44.5,25,71.5s-9.6,52.6-25.7,72.4l-1.4,1.7l-0.4-2.2c-0.3-1.8-0.7-3.7-1.1-5.6
